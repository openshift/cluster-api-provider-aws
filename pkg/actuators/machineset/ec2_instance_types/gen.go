...
import (
	...
	klog "k8s.io/klog/v2"
	aws "sigs.k8s.io/cluster-api-provider-aws/pkg/actuators/machineset"
)

// Source: https://github.com/kubernetes/autoscaler/blob/master/cluster-autoscaler/cloudprovider/aws/ec2_instance_types/gen.go
